package cloudera.cdf.cde.spark.example.geekmj;
...
public class SparkDriverProgram {
    public static void main(String args[]) {
        ...
        JavaRDD<String> lines = sc.textFile(
        		"/Users/gvetticaden/Dropbox/Hortonworks/Development/Git/apache-spark-examples/data/apache-log04-aug-31-aug-2011-nasa.log");
        		*/
        
        JavaRDD<String> lines = sc.textFile(
        		"/Users/gvetticaden/Dropbox/Hortonworks/Development/Git/cdf-ref-app/cde-trucking-spark/src/main/resources/examples/geekmj/apache-log04-aug-31-aug-2011-nasa.log");
