package cloudera.cdf.cde.spark.example.sql;
...
public class JavaSparkSQLExample {
	...
	private static void runBasicDataFrameExample(SparkSession spark)
		...
		Dataset<Row> df = spark.read().json(
				"/Users/gvetticaden/Dropbox/Hortonworks/Development/Git/cdf-ref-app/cde-trucking-spark/src/main/resources/examples/people.json");
	...
	private static void runInferSchemaExample(SparkSession spark) {
		...
		Dataset<String> teenagerNamesByFieldDF = teenagersDF.map(
				(MapFunction<Row, String>) row -> "Name: "
						+ row.<String> getAs("name"), stringEncoder);
