package cloudera.cdf.refapp.trucking.simulator.runner.file;
...
public class NewMultiFileSimulationRunnerTruckFleetApp {
	public static void main(String[] args) {
			try {
				...
				final ActorRef eventCollector = system.actorOf(
						Props.create(eventCollectorClass, bucketKey, eventSource, numOfEventsPerFile), "eventCollector");
