package cloudera.cdf.refapp.trucking.simulator.runner.azure;
...
public class AzureMultiFileSimulationRunnerTruckFleetApp {
	public static void main(String[] args) {
			try {
				...
				final String azureContainerName = args[9];
				
				final String directoryName = args[10];
				...
				final ActorRef eventCollector = system.actorOf(
						Props.create(eventCollectorClass, fileName, eventSource, numOfEventsPerFile, azureContainerName, directoryName), "eventCollector");
