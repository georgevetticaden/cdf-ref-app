...
import cloudera.cdf.refapp.trucking.simulator.domain.transport.route.RouteProvided;
import cloudera.cdf.refapp.trucking.simulator.domain.transport.route.TruckRoutesParser;
