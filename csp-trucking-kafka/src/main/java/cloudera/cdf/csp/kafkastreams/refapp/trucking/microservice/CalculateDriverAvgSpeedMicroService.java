...
import cloudera.cdf.csp.kafkastreams.refapp.trucking.aggregrator.DriverAvgSpeedAgregrator;
...
import cloudera.cdf.csp.kafkastreams.refapp.trucking.serde.DriverSpeedAvgValueSerde;
import cloudera.cdf.csp.kafkastreams.refapp.trucking.serde.DriverSpeedRunningCountAndSumSerde;
import cloudera.cdf.csp.kafkastreams.refapp.trucking.serde.TruckGeoSpeedJoinSerde;
import cloudera.cdf.csp.kafkastreams.refapp.trucking.serde.WindowSerde;
